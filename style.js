...
<footer class="footer-social">
  ...
  <section class="kontak-container">
    <div class="kontak-info">
      <h2>Hubungi Kami</h2>
      <p>Jika Anda memiliki pertanyaan, kritik, atau saran, silakan hubungi kami melalui formulir berikut atau informasi kontak yang tersedia.</p>
      
      <ul>
        <li><strong>Alamat:</strong> Jl. Contoh No.123, Sumenep</li>
        <li><strong>Email:</strong> izam.com</li>
